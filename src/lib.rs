...
pub const FC_STYLE: &str = "style";
pub const FC_SLANT: &str = "slant";
pub const FC_WEIGHT: &str = "weight";
pub const FC_SIZE: &str = "size";
pub const FC_ASPECT: &str = "aspect";
pub const FC_PIXEL_SIZE: &str = "pixelsize";
pub const FC_SPACING: &str = "spacing";
pub const FC_FOUNDRY: &str = "foundry";
pub const FC_ANTIALIAS: &str = "antialias";
pub const FC_HINTING: &str = "hinting";
pub const FC_HINT_STYLE: &str = "hintstyle";
pub const FC_VERTICAL_LAYOUT: &str = "verticallayout";
pub const FC_AUTOHINT: &str = "autohint";
pub const FC_GLOBAL_ADVANCE: &str = "globaladvance";
pub const FC_WIDTH: &str = "width";
pub const FC_FILE: &str = "file";
pub const FC_INDEX: &str = "index";
pub const FC_FT_FACE: &str = "ftface";
pub const FC_RASTERIZER: &str = "rasterizer";
pub const FC_OUTLINE: &str = "outline";
pub const FC_SCALABLE: &str = "scalable";
pub const FC_COLOR: &str = "color";
pub const FC_VARIABLE: &str = "variable";
pub const FC_SCALE: &str = "scale";
pub const FC_SYMBOL: &str = "symbol";
pub const FC_DPI: &str = "dpi";
pub const FC_RGBA: &str = "rgba";
pub const FC_MINSPACE: &str = "minspace";
pub const FC_SOURCE: &str = "source";
pub const FC_CHARSET: &str = "charset";
pub const FC_LANG: &str = "lang";
pub const FC_FONTVERSION: &str = "fontversion";
pub const FC_FULLNAME: &str = "fullname";
pub const FC_FAMILYLANG: &str = "familylang";
pub const FC_STYLELANG: &str = "stylelang";
pub const FC_FULLNAMELANG: &str = "fullnamelang";
pub const FC_CAPABILITY: &str = "capability";
pub const FC_FONTFORMAT: &str = "fontformat";
pub const FC_EMBOLDEN: &str = "embolden";
pub const FC_EMBEDDED_BITMAP: &str = "embeddedbitmap";
pub const FC_DECORATIVE: &str = "decorative";
pub const FC_LCD_FILTER: &str = "lcdfilter";
pub const FC_FONT_FEATURES: &str = "fontfeatures";
pub const FC_FONT_VARIATIONS: &str = "fontvariations";
pub const FC_NAMELANG: &str = "namelang";
pub const FC_PRGNAME: &str = "prgname";
pub const FC_HASH: &str = "hash";
pub const FC_POSTSCRIPT_NAME: &str = "postscriptname";

pub const FC_CACHE_SUFFIX: &str = concat!(".cache-", FC_CACHE_VERSION!());
pub const FC_DIR_CACHE_FILE: &str = concat!("fonts.cache-", FC_CACHE_VERSION!());
pub const FC_USER_CACHE_FILE: &str = concat!(".fonts.cache-", FC_CACHE_VERSION!());

pub const FC_CHARWIDTH: &str = "charwidth";
pub const FC_CHAR_WIDTH: &str = FC_CHARWIDTH;
pub const FC_CHAR_HEIGHT: &str = "charheight";
pub const FC_MATRIX: &str = "matrix";
